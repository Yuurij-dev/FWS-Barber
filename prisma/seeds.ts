...
async function seedDatabase() {
  try {
    ...
    const schedules = [
      ...
      { dayOfWeek: 1, isClosed: true }, // Segunda
      ...
      { dayOfWeek: 6, openTime: "08:00", closeTime: "17:00", isClosed: false },
    ]
    ...
    console.log("✅ Seed concluída com barbearias, serviços e horários")
